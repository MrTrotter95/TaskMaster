...
namespace TaskMasterWeb.Controllers
{
    public class ProjectStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StatusID,StatusValue")] ProjectStatus projectStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StatusID,StatusValue")] ProjectStatus projectStatus)
        {
            if (ModelState.IsValid)
            {
